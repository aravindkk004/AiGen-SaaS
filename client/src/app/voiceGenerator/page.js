...
import VoiceGenerator from "@/components/VoiceGenerator/VoiceGenerator";
    ...
    <>
      <PrivateRoute>
        ...
        <div
          ...
          >
            <LeftNav name="voiceGenerator" open={openSidenav}
              openSidenav={handleOpenSidenav}/>
          </div>
          <div className="lg:w-[80%] w-full overflow-scroll">
            <VoiceGenerator openSidenav={handleOpenSidenav}
              username={username} />
          </div>
        </div>
      </PrivateRoute>
